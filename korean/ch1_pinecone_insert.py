...
# PDF 로딩 및 텍스트 추출
pdf_filepath = r"/Users/collegenie/Desktop/RAG/국어(천재노)/1. 새로운 시작/국어1-1(노)_1-0-0_지도서_천재교육.pdf"
...
for text, emb in zip(texts, embeddings_model.embed_documents(texts)):
    ...
    metadata = {"text": text, "main_category": "문학", "sub_category": "산문"}
    vector_data = {
        "id": vector_id,
